...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        self.dug = set() # ex: dig at 0, 0, then self.dug = {(0,0)}
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            col = loc % self.dim_size  # the remainder tells us what index in that row to look at

            if board[row][col] == '*':
                #  planted a bomb there already so keep going
                continue
    ...
    def assign_values_to_board(self):
        # now the bombs planted, assign a number 0-8 for all the empty spaces
        #it represents how many neighboring bombs there are. it can be precomputed 
    ...
    def dig(self, row, col):
        ...
        self.dug.add((row, col)) # keep track that we dug this here
